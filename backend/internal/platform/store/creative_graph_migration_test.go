...
func TestCanvasMigrationSeedsOnceAndRefusesLossyRollback(t *testing.T) {
	...
	for _, label := range []string{
		"0051 generation-media-facts", "0050 execution-continuations", "0049 agent-controls", "0048 agent-checkpoints", "0047 agent-context", "0046 agent-runs", "0045 skill-foundation", "0044 agent-conversations",
		"0043 llm-gateway",

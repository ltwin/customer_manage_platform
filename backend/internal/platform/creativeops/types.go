...
func NewResourceID(prefix string) (string, error) {
	switch prefix {
	case "ccnt", "ccrv", "ccrd", "ccug", "ccup", "ccuc", "ccbl", "ccpn", "cchd", "ccas", "ccag", "cctg", "cctc", "ccpj", "cccv", "cwnode", "cwedge", "cwinp", "ccch", "ccco", "ccms", "ccec", "ccsk", "ccsv", "ccsi", "ccrn", "ccst", "ccci", "cccp":

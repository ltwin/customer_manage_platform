...
```bash
python3 <cs-onboard skill 目录>/tools/codestable-goal-consistency-gate.py --roadmap .codestable/roadmap/creative-shoot-planning
```
...
写 `.codestable/roadmap/creative-shoot-planning/goal-audit.md`：
...
# creative-shoot-planning Goal 最终审计
...
同时写 `.codestable/roadmap/creative-shoot-planning/goal-evidence-summary.md` 或在 goal-audit 第 7 节等价内嵌：feature evidence packs、provider unavailable / warnings、final aggregate commands、E/C/H summary、H-only core checks。

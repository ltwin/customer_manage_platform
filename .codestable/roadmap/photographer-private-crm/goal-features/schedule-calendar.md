...
# schedule-calendar Goal Feature 规格

## 1. Mapping

- Roadmap item: `schedule-calendar`
- Feature dir: `.codestable/features/2026-07-09-schedule-calendar`
...
- Design review: `.codestable/features/2026-07-09-schedule-calendar/schedule-calendar-design-review.md`
- Review: `.codestable/features/2026-07-09-schedule-calendar/schedule-calendar-review.md`
- QA: `.codestable/features/2026-07-09-schedule-calendar/schedule-calendar-qa.md`
- Acceptance: `.codestable/features/2026-07-09-schedule-calendar/schedule-calendar-acceptance.md`
...
月历、跨日/全天 slot CRUD、订单关联、重叠提示和结果未知恢复。

## 3. Core Runtime Path

从 Calendar/Customer 创建订单关联档期 → 月历与 drawer 展示 → 重叠明细 → 中断后按幂等键恢复且不重复。
...
- `.codestable/features/2026-07-09-schedule-calendar/schedule-calendar-evidence-pack.md`
- `.codestable/features/2026-07-09-schedule-calendar/schedule-calendar-evidence-pack-results.json`
- `.codestable/features/2026-07-09-schedule-calendar/schedule-calendar-gate-results.json`
- `.codestable/features/2026-07-09-schedule-calendar/schedule-calendar-dod-results.json`
- `.codestable/features/2026-07-09-schedule-calendar/schedule-calendar-dod-contract-results.json`
- `.codestable/features/2026-07-09-schedule-calendar/schedule-calendar-review.md`
- `.codestable/features/2026-07-09-schedule-calendar/schedule-calendar-qa.md`
- `.codestable/features/2026-07-09-schedule-calendar/schedule-calendar-acceptance.md`

Package creation baseline missing modern/future artifacts: `schedule-calendar-evidence-pack.md`, `schedule-calendar-evidence-pack-results.json`, `schedule-calendar-gate-results.json`, `schedule-calendar-dod-results.json`, `schedule-calendar-dod-contract-results.json`.

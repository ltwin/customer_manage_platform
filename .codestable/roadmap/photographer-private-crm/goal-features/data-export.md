...
# data-export Goal Feature 规格

## 1. Mapping

- Roadmap item: `data-export`
- Feature dir: `.codestable/features/2026-07-21-data-export`
...
- Design review: `.codestable/features/2026-07-21-data-export/data-export-design-review.md`
- Review: `.codestable/features/2026-07-21-data-export/data-export-review.md`
- QA: `.codestable/features/2026-07-21-data-export/data-export-qa.md`
- Acceptance: `.codestable/features/2026-07-21-data-export/data-export-acceptance.md`
- Dependencies: `customer-profile-complete`, `customer-avatar`, `package-catalog`, `order-tracking`, `schedule-calendar`, `reminder-engine`
- Nature: `mixed`
- Goal baseline status: `accepted-baseline`

## 2. Deliverable

账号级一致快照的 reference-only JSON 全量导出与设置页下载。

## 3. Core Runtime Path

设置页一键导出 → 七类实体/Settings arrays 与 counts 一致 → 账号隔离/READ ONLY/snapshot 成立 → 内部字段、凭证与头像 binary/object_id 排除。
...
- `cd backend && go test ./internal/platform/store/... ./internal/dataexport/... ./internal/platform/httpapi/... ./cmd/server/... -count=1 -parallel=1`
- `cd frontend && npm run test:data-export && npm run build`
...
- `.codestable/features/2026-07-21-data-export/data-export-qa.md`
- `.codestable/features/2026-07-21-data-export/data-export-acceptance.md`

Package creation baseline has the modern canonical artifacts; final audit must still recompute identity/hash/status rather than trust filenames.

...
# customer-core Goal Feature 规格

## 1. Mapping

- Roadmap item: `customer-core`
- Feature dir: `.codestable/features/2026-07-07-customer-core`
...
- Design review: `.codestable/features/2026-07-07-customer-core/customer-core-design-review.md`
- Review: `.codestable/features/2026-07-07-customer-core/customer-core-review.md`
- QA: `.codestable/features/2026-07-07-customer-core/customer-core-qa.md`
- Acceptance: `.codestable/features/2026-07-07-customer-core/customer-core-acceptance.md`
...
30 秒建档、客户列表搜索与详情的最小业务闭环。

## 3. Core Runtime Path

登录 → 建带渠道和至少一个社交身份的客户 → 列表搜索命中 → 打开详情；跨账号访问不可见。
...
- `.codestable/features/2026-07-07-customer-core/customer-core-evidence-pack.md`
- `.codestable/features/2026-07-07-customer-core/customer-core-evidence-pack-results.json`
- `.codestable/features/2026-07-07-customer-core/customer-core-gate-results.json`
- `.codestable/features/2026-07-07-customer-core/customer-core-dod-results.json`
- `.codestable/features/2026-07-07-customer-core/customer-core-dod-contract-results.json`
- `.codestable/features/2026-07-07-customer-core/customer-core-review.md`
- `.codestable/features/2026-07-07-customer-core/customer-core-qa.md`
- `.codestable/features/2026-07-07-customer-core/customer-core-acceptance.md`

Package creation baseline missing modern/future artifacts: `customer-core-evidence-pack.md`, `customer-core-evidence-pack-results.json`, `customer-core-gate-results.json`, `customer-core-dod-results.json`, `customer-core-dod-contract-results.json`.

...
# reminder-engine Goal Feature 规格

## 1. Mapping

- Roadmap item: `reminder-engine`
- Feature dir: `.codestable/features/2026-07-12-reminder-engine`
...
- Design review: `.codestable/features/2026-07-12-reminder-engine/reminder-engine-design-review.md`
- Review: `.codestable/features/2026-07-12-reminder-engine/reminder-engine-review.md`
- QA: `.codestable/features/2026-07-12-reminder-engine/reminder-engine-qa.md`
- Acceptance: `.codestable/features/2026-07-12-reminder-engine/reminder-engine-acceptance.md`
- Dependencies: `customer-profile-complete`, `order-tracking`
- Nature: `functional`
- Goal baseline status: `accepted-baseline`

## 2. Deliverable

按账号时区幂等生成生日/回访/流失提醒，支持 done/dismiss 与 Settings 参数。

## 3. Core Runtime Path

准备客户/订单/Settings → scan/runner 生成提醒 → 列表核对 → done/dismiss → 重跑不重复且时区日界正确。
...
- `.codestable/features/2026-07-12-reminder-engine/reminder-engine-evidence-pack.md`
- `.codestable/features/2026-07-12-reminder-engine/reminder-engine-evidence-pack-results.json`
- `.codestable/features/2026-07-12-reminder-engine/reminder-engine-gate-results.json`
- `.codestable/features/2026-07-12-reminder-engine/reminder-engine-dod-results.json`
- `.codestable/features/2026-07-12-reminder-engine/reminder-engine-dod-contract-results.json`
- `.codestable/features/2026-07-12-reminder-engine/reminder-engine-review.md`
- `.codestable/features/2026-07-12-reminder-engine/reminder-engine-qa.md`
- `.codestable/features/2026-07-12-reminder-engine/reminder-engine-acceptance.md`

Package creation baseline missing modern/future artifacts: `reminder-engine-evidence-pack-results.json`, `reminder-engine-gate-results.json`, `reminder-engine-dod-results.json`, `reminder-engine-dod-contract-results.json`.

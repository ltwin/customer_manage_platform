...
# package-catalog Goal Feature 规格

## 1. Mapping

- Roadmap item: `package-catalog`
- Feature dir: `.codestable/features/2026-07-08-package-catalog`
...
- Design review: `.codestable/features/2026-07-08-package-catalog/package-catalog-design-review.md`
- Review: `.codestable/features/2026-07-08-package-catalog/package-catalog-review.md`
- QA: `.codestable/features/2026-07-08-package-catalog/package-catalog-qa.md`
- Acceptance: `.codestable/features/2026-07-08-package-catalog/package-catalog-acceptance.md`
- Dependencies: `platform-skeleton`
- Nature: `functional`
- Goal baseline status: `accepted-baseline`

## 2. Deliverable

套系 CRUD、上下架、引用保护与真实 PackagesPage。

## 3. Core Runtime Path

创建套系 → 编辑价格/参数 → 下架/恢复 → 查询过滤 → 对未引用套系删除；跨账号和 in-use 边界符合契约。
...
- `.codestable/features/2026-07-08-package-catalog/package-catalog-evidence-pack.md`
- `.codestable/features/2026-07-08-package-catalog/package-catalog-evidence-pack-results.json`
- `.codestable/features/2026-07-08-package-catalog/package-catalog-gate-results.json`
- `.codestable/features/2026-07-08-package-catalog/package-catalog-dod-results.json`
- `.codestable/features/2026-07-08-package-catalog/package-catalog-dod-contract-results.json`
- `.codestable/features/2026-07-08-package-catalog/package-catalog-review.md`
- `.codestable/features/2026-07-08-package-catalog/package-catalog-qa.md`
- `.codestable/features/2026-07-08-package-catalog/package-catalog-acceptance.md`

Package creation baseline missing modern/future artifacts: `package-catalog-evidence-pack.md`, `package-catalog-evidence-pack-results.json`, `package-catalog-gate-results.json`, `package-catalog-dod-results.json`, `package-catalog-dod-contract-results.json`.

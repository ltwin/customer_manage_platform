...
# telegram-digest Goal Feature 规格

## 1. Mapping

- Roadmap item: `telegram-digest`
- Feature dir: `.codestable/features/2026-07-15-telegram-digest`
...
- Design review: `.codestable/features/2026-07-15-telegram-digest/telegram-digest-design-review.md`
- Review: `.codestable/features/2026-07-15-telegram-digest/telegram-digest-review.md`
- QA: `.codestable/features/2026-07-15-telegram-digest/telegram-digest-qa.md`
- Acceptance: `.codestable/features/2026-07-15-telegram-digest/telegram-digest-acceptance.md`
- Dependencies: `reminder-engine`, `schedule-calendar`
- Nature: `mixed`
- Goal baseline status: `accepted-baseline`

## 2. Deliverable

安全 Bot 绑定、每日经营摘要、/today、claim/lease/fence 与可恢复投递。

## 3. Core Runtime Path

生成 bind token → 真实私聊绑定 → 同账号时区 daily digest 与 /today → 失败重试/退避/重绑/offset 恢复且不跨账号。
...
- `cd backend && go test ./internal/reminder/... ./internal/settings/... ./internal/platform/config/... ./internal/platform/httpapi/... ./cmd/server/... -count=1 -parallel=1`
...
- `.codestable/features/2026-07-15-telegram-digest/telegram-digest-evidence-pack.md`
- `.codestable/features/2026-07-15-telegram-digest/telegram-digest-evidence-pack-results.json`
...
- `.codestable/features/2026-07-15-telegram-digest/telegram-digest-dod-contract-results.json`
- `.codestable/features/2026-07-15-telegram-digest/telegram-digest-review.md`
- `.codestable/features/2026-07-15-telegram-digest/telegram-digest-qa.md`
- `.codestable/features/2026-07-15-telegram-digest/telegram-digest-acceptance.md`

Package creation baseline missing modern/future artifacts: `telegram-digest-dod-contract-results.json`.

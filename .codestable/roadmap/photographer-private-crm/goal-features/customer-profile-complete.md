...
# customer-profile-complete Goal Feature 规格

## 1. Mapping

- Roadmap item: `customer-profile-complete`
- Feature dir: `.codestable/features/2026-07-07-customer-profile-complete`
...
- Design review: `.codestable/features/2026-07-07-customer-profile-complete/customer-profile-complete-design-review.md`
- Review: `.codestable/features/2026-07-07-customer-profile-complete/customer-profile-complete-review.md`
- QA: `.codestable/features/2026-07-07-customer-profile-complete/customer-profile-complete-qa.md`
- Acceptance: `.codestable/features/2026-07-07-customer-profile-complete/customer-profile-complete-acceptance.md`
- Dependencies: `customer-core`
- Nature: `functional`
- Goal baseline status: `accepted-baseline`

## 2. Deliverable

渐进档案、身份增删、备注、归档/恢复、合并与转介绍指针维护。

## 3. Core Runtime Path

已有客户补字段/身份/备注 → 归档与恢复 → 合并并核对 source/target、转介绍和跨账号边界。
...
- `.codestable/features/2026-07-07-customer-profile-complete/customer-profile-complete-evidence-pack.md`
- `.codestable/features/2026-07-07-customer-profile-complete/customer-profile-complete-evidence-pack-results.json`
- `.codestable/features/2026-07-07-customer-profile-complete/customer-profile-complete-gate-results.json`
- `.codestable/features/2026-07-07-customer-profile-complete/customer-profile-complete-dod-results.json`
- `.codestable/features/2026-07-07-customer-profile-complete/customer-profile-complete-dod-contract-results.json`
- `.codestable/features/2026-07-07-customer-profile-complete/customer-profile-complete-review.md`
- `.codestable/features/2026-07-07-customer-profile-complete/customer-profile-complete-qa.md`
- `.codestable/features/2026-07-07-customer-profile-complete/customer-profile-complete-acceptance.md`

Package creation baseline missing modern/future artifacts: `customer-profile-complete-evidence-pack.md`, `customer-profile-complete-evidence-pack-results.json`, `customer-profile-complete-gate-results.json`, `customer-profile-complete-dod-results.json`, `customer-profile-complete-dod-contract-results.json`.

...
# dashboard Goal Feature 规格

## 1. Mapping

- Roadmap item: `dashboard`
- Feature dir: `.codestable/features/2026-07-14-dashboard`
...
- Design review: `.codestable/features/2026-07-14-dashboard/dashboard-design-review.md`
- Review: `.codestable/features/2026-07-14-dashboard/dashboard-review.md`
- QA: `.codestable/features/2026-07-14-dashboard/dashboard-qa.md`
- Acceptance: `.codestable/features/2026-07-14-dashboard/dashboard-acceptance.md`
- Dependencies: `order-tracking`, `schedule-calendar`, `reminder-engine`
- Nature: `functional`
- Goal baseline status: `accepted-baseline`

## 2. Deliverable

登录默认五卡经营台，聚合待办、今日档期、待收尾款、流失与近 30 天统计。

## 3. Core Runtime Path

登录落 dashboard → 五卡与领域 API 交叉核对 → 在台上 done/dismiss 提醒和标尾款 → 刷新后聚合一致。
...
- `.codestable/features/2026-07-14-dashboard/dashboard-evidence-pack.md`
- `.codestable/features/2026-07-14-dashboard/dashboard-evidence-pack-results.json`
- `.codestable/features/2026-07-14-dashboard/dashboard-gate-results.json`
- `.codestable/features/2026-07-14-dashboard/dashboard-dod-results.json`
- `.codestable/features/2026-07-14-dashboard/dashboard-dod-contract-results.json`
- `.codestable/features/2026-07-14-dashboard/dashboard-review.md`
- `.codestable/features/2026-07-14-dashboard/dashboard-qa.md`
- `.codestable/features/2026-07-14-dashboard/dashboard-acceptance.md`

Package creation baseline missing modern/future artifacts: `dashboard-evidence-pack.md`, `dashboard-evidence-pack-results.json`, `dashboard-gate-results.json`, `dashboard-dod-results.json`, `dashboard-dod-contract-results.json`.
